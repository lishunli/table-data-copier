...
public class TableDataCopier extends JFrame {
    ...
    public TableDataCopier() {
        ...
        textField_4_0.setFont(new Font("Microsoft YaHei", Font.PLAIN, 16));
        textField_4_0.setColumns(25);
        ...
        label_5.setFont(new Font("Microsoft YaHei", Font.PLAIN, 16));
        panel_5.add(label_5);

        textField_4_1 = new JTextField();
        textField_4_1.setFont(new Font("Microsoft YaHei", Font.PLAIN, 16));
        textField_4_1.setColumns(25);
    ...
    private void copy() {
        ...
        String toTable = textField_4_1.getText().trim();
        String tableName = null, deleteSql = null, countSql = null, selectSql = null;
        StringBuffer statisticsInfo = new StringBuffer();
        ...
        try {
            ...
            if (IS_DELETE_ORIGINAL_DATA) {
                ...
                int deleteRecords = jdbcTemplateTo.update(deleteSql, paramMap);
                logger.info("Delete {} records", deleteRecords);
                statisticsInfo.append("Delete " + deleteRecords + " records\n");
                stopWatch.stop();
            ...
            statisticsInfo.append("Select " + size + " records\n");
            ...
            statisticsInfo.append("Insert " + updateNums + " records");
